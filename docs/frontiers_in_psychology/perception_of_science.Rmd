...
runtitle: "Perception of Science"
documentclass: frontiersSCNS #frontiersSCNS, or frontiersHLTH, or frontiersFPHY
author:
  - name: Ph. Grosjean
    affiliation: '1,2'
    etal: Grosjean # First author's last name.
    email: philippe.grosjean@umons.ac.be # Indicates corresponding Author
    institution: Numerical Ecology Department, University of Mons
    street: 20, Place de Parc
    city: Mons
    zip: 7000
    country: Belgium
  - name: J. James
...
affiliation:
  - id: '1'
    department: STAT for U
    institution: University of Mons
    country: Belgium
  - id: '2' 
    department: Numerical Ecology Department, Complexys and Infortech Institutes
    institution: University of Mons
    country: Belgium
