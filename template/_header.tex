...
% UMONS-STATforU template configuration
\mode<all>
{
...
height=1.07\paperheight]{../../template/backgroundTech.pdf}}
  % The logo picture
  \logo{\includegraphics[width=2cm]{../../template/STATforU.pdf}}
}
\mode<handout>
{
...
% UMONS-STATforU template is partly inspired from a work done by:
